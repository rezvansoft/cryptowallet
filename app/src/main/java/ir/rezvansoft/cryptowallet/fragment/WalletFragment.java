package ir.rezvansoft.cryptowallet.fragment;
...
import ir.rezvansoft.cryptowallet.activity.AddWalletActivity;
import ir.rezvansoft.cryptowallet.adapter.WalletRecyclerAdapter;
...
import ir.rezvansoft.cryptowallet.util.RecyclerviewSearchListener;
import ir.rezvansoft.cryptowallet.viewmodel.WalletViewModel;
                ...
                new SwipeRefreshLayout.OnRefreshListener() {
                    ...
                    public void onRefresh() {
                        ...
                        if (!connectivity.isConnected()) {
                            ...
                            Toast.makeText(getContext(), "خطا در برقرای ارتباط!", Toast.LENGTH_SHORT).show();
                            return;
                        }
